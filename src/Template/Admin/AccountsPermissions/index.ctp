...
<div class="list-items">
	<table class="table table-bordered table-hover table-striped">
		<tr>
			...
			<td style="width: 20%"><?= __('controller');?></td>
            <td style="width: 50%"><?= __('actions');?></td>
		...
		<tr>
			...
			<td style="vertical-align: middle;"><?= $this->Html->link(h($data->controller), ['controller' => 'AccountsPermissions', 'action' => 'edit', $data->id]);?></td>
            <td style="vertical-align: middle;">                
                <?php foreach ($data->array_actions as $act) :?>
